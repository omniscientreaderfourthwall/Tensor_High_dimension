...
if args.test_case == "Exp_4_3":
    ...
    initial_guess = 0.2 * jax.random.normal(key_ini, shape = (10, 6))
    sde_argnums = [6, 2500000, 10, 0.001, initial_guess, func_4_3]
...
ref_data_set = ref_data_generation(num_train, 4, center, edge_length, 0.8, traj_ref_train_generation)
...
time_file_name = Save_Path + "time.txt"

time_use = str(time.time() - start_time) + "---seconds"
