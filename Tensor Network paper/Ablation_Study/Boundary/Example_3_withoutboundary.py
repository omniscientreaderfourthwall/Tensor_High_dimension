...
parser.add_argument('--test_case', type=str, default="Exp 4.3 without boundary")
parser.add_argument('--Chosen_List', type=list, default= ["wendland", "inverse_quadratic", "wendland"])
parser.add_argument('--rank', type = dict, default = 800)
parser.add_argument('--rbf_types', type = str, default = "three_two", help = "three_one/two")
